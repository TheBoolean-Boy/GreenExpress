...
const Card = (props) => {
  ...
  return (
    <div className=' bg-white/40 rounded-2xl max-w-[320px] max-h-[450px] mx-auto flex flex-col items-center shadow-sm hover:shadow-[0px_8px_10px_0px_rgba(0,0,0,0.1)] overflow-hidden cursor-pointer transition-all duration-300 hover:scale-105'>
